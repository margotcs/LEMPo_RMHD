% =========================================================================
% Example: Run LEMPo_res for m/n=1/1 mode with a reversed q profile
% =========================================================================
%
% This script demonstrates how to run the LEMPo_res solver using a 
...
alphaWanted = 0.001;  % Desired alpha at RS
...
[ev, result] = LEMPo_res(m, n, N, ev_guess, toPlot, profiles, opts);
